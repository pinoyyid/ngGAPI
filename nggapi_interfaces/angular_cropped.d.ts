...
declare module mng {
    ...
    interface IFormController {
        ...
        $invalid: boolean;
        $error: any;
        $addControl(control: mng.INgModelController): void;
        $removeControl(control: mng.INgModelController): void;
        $setDirty(): void;
        $setPristine(): void;
    }
    ...
    export module auto {
        ...
        interface IProvideService {
            ...
            factory(name: string, serviceFactoryFunction: Function): mng.IServiceProvider;
            factory(name: string, inlineAnnotatedFunction: any[]): mng.IServiceProvider;
            provider(name: string, provider: mng.IServiceProvider): mng.IServiceProvider;
            provider(name: string, serviceProviderConstructor: Function): mng.IServiceProvider;
            service(name: string, constructor: Function): mng.IServiceProvider;
            value(name: string, value: any): mng.IServiceProvider;
        }
